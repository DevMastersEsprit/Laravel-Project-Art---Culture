                                                    ...
                                                    <div class="col-lg-12 col-sm-12 mt-5">
                                                        <div class="card blur border border-white mb-4 shadow-xs">
                                                            <div class="card-body p-4">
                                                                ...
                                                                <p>{{ $actor->fullName }}, born on
                                                                    {{ $actor->birthDate }} in
                                                                    {{ $actor->birthPlace }}
                                                                    and of {{ $actor->nationality }} nationality</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-12 col-sm-12">
                                                        <div class="card blur border border-white mb-4 shadow-xs">
                                                            <div class="card-body p-4">
                                                                ...
                                                                <p>Phone Number : {{ $actor->phoneNumber }}</p>
                                                                <p>Social Connections : {{ $actor->socialConnections }}
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
