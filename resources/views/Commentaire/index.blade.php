                            ...
                            <li class="mb-2">
                                <a class="border-radius-md">
                                    ...
                                    <div class=" row  justify-content-center">
                                        ...
                                        <div class="col-1">
                                            <form class="row" action="{{ route('removeEmoji') }}" method="POST">
                                                @csrf
                                                <div class="col-6">
                                    ...
                                    <div class="row">
                                        <div class="col-11">
                                            <div class="d-flex flex-row-reverse">
                                                ...
                                                <div class="scrollable-div col-5" id="emojiContainer{{$comment->id}}"></div>
                                                <script>
                                                    document.getElementById('showEmojis{{$comment->id}}').addEventListener('click', function() {
                                                        ...
                                                        if (emojiContainer.style.display === 'block') {
                                                            ...
                                                            emojis.forEach(function(emoji) {
                                                                ...
                                                                if ((document.getElementById('emojiContainer{{$comment->id}}').innerHTML.length) < emojis.length * 50 //228
                                                                ) {
